...
<div class="form" >
<form id="account" action="WithdrawAmount" method="post">
  <table>
  <tr>
	...
	<tr>
		...
		<tr>
			...
			<td><input type="number" placeholder="Enter your amount for withdraw" name="withdraw"></td>
		
		</tr>
        <tr>
		<td><button type="submit" class="btn btn-dark" id="log">WITHDRAW</button></td>
		</tr>
